...
Mesh::Mesh(Vertex* vertArray, int vertCount, unsigned* indices, int indicesCount, ID3D11Device* device)
{
	...
	ibd.ByteWidth = sizeof(int) * indicesCount;         // 3 = number of indices in the buffer
