...
float4 main(VertexToPixel input) : SV_TARGET
{
	...
	float indexOfRefr = 0.91f; // Ideally keep this below 1 - not physically accurate, but prevents "total internal reflection"
	...
	return ScenePixels.Sample(RefractSampler, input.screenUV );
